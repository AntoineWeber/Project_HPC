...
NBodyVisualizer::NBodyVisualizer(const SimulationParameters p, const int numBodies)
{
...
NBodyVisualizer::NBodyVisualizer(const NBodyVisualizer &visualizer)
{
...
NBodyVisualizer& NBodyVisualizer::operator=(const NBodyVisualizer &visualizer)
{
	if(this != &visualizer){
		numOfBodies = visualizer.numOfBodies;
		parameters = visualizer.parameters;
...
NBodyVisualizer::~NBodyVisualizer()
{
	delete particles;
...
void NBodyVisualizer::displayDeviceProperties()
{
	// Set up CUDA device 
...
void NBodyVisualizer::runSimulation()
{
